...
const ConfirmationScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-checkered flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="bg-gradient-entry rounded-3xl p-8 text-white shadow-2xl">
        ...
        {/* Footer Section */}
        <div className="bg-white rounded-2xl mt-4 p-6 text-center shadow-lg">
